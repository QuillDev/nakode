...
- Authenticated source-call relays derive downward delegated instruction from immutable same-owner parent links; peer/upward content stays inert. Structured batch display and exact-turn bounded final reports persist independently of model text. `docs/coordination-messages.md`.
