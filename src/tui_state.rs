...
impl AgentEditor {
    ...
    fn from_definition(definition: &AgentDefinitionView) -> Self {
        Self {
            ...
            tool_profile: definition.tool_profile.clone(),
            ...
            fallback_policy: definition.fallback_policy.clone(),
    ...
    pub fn definition_input(&self) -> Option<AgentDefinitionInput> {
        ...
        Some(AgentDefinitionInput {
            ...
            task_shape: self.task_shape.clone(),
            ...
            require_parent_attribution: self.require_parent_attribution,
        })
    }
}
